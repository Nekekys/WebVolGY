...
--
-- Хост: 127.0.0.1
-- Время создания: Окт 02 2021 г., 13:24
...
(1, 'Шорты женские Fjora Flex1', 'Шорты Norrona Fjora Flex1 созданы для катания на горном велосипеде. Они подойдут для разных погодных условий и в них вам будет комфортно и в солнечный день, и в дождливый.', 8940, 2, 'img1.jpg'),
...
(17, 'Палатка Minima', 'Minima 3 SL - ультралёгкая, двухместная двухслойная палатка от Camp. Полный вес палатки – 2100 грамм. Она разрабатывалась специально для сложных мультигонок и походов. Палатка быстро устанавливается на двух дугах.', 21693, 1, 'img17.jpg'),
(18, 'Рюкзак M20', 'M20 - современный рюкзак для альпинизма, прохождения виа феррат и мультипитчей, а также походов в стиле fast&light. Серия рюкзаков М в линейке фирмы CAMP выпускается много лет и по праву считается одной из самых удачных линеек альпинистских рюкзаков.', 7903, 1, 'img18.jpg'),
