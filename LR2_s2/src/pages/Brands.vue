        ...
        methods: {
            ...
            deleteItemConfirm () {
                if (this.currentIndex > -1){
                    this.$store.commit("reloadBrandElementGoods",{newBrand: this.currentIndex, oldBrand: this.editedItem.name});
                    this.$store.commit("deleteElementGoods",this.editedIndex);
                }else{
                    this.$store.commit("deleteElementGoods",this.editedIndex);
                }
            ...
            save () {
                if (this.editedIndex > -1) {
                    ...
                    this.$store.commit("addElementBrands",this.editedItem);
